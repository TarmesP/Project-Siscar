                    ...
                    while (opcsub != 29)
                    {
                        ...
                        switch (opcsub)
                        {
                            case 20:
                                ...
                                // Criação de um novo item VEICULOS
                            ...
                            case 21:
                                ...
                                // Alterando um item a partir de uma busca por Nome
                                Console.Write("Nome para Alterar: ");
                                string nomeParaAlterar = Console.ReadLine().Trim();

                                // Percorrendo a lista (banco) para encontrar e alterar o item
                        ...
                        switch (opcsub)
                        {
                            ...
                            case 33:
                                ...
                                foreach (var modelo in bancoModelos)
                                {
                                    ...
                                    {
                                        Console.Write("Codigo: " + modelo.modid);

                                        Console.Write("Nome: " + modelo.modnome);

                                        Console.Write("Observacao: " + modelo.modobservacoes);
                            ...
                            case 34:
                                Console.WriteLine("Exibindo MODELOS: ");
